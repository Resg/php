...
if ($COUNTER["resolution"]=="1024") {
        ...
        $TABLE="<table width='".$TW."' cellspacing='1' border='0' cellpadding='3' class=tblborder style='table-layout:fixed;' ".$TA.">\n";
        $BBG="bbg1024.gif";
        }
else {
        $IMGW=465;
...
function FormFilter($title) {
        ...
        print "</SELECT>\n";
        print "</td><td><input type='image' src='img/go.gif' width='19' height='18' alt='Применить' border=''0'></td></tr></table>\n";
        print "</form>\n";
        }


$LANG["softname"]="Статистика сайта";
$LANG["copyright"]="";
?>
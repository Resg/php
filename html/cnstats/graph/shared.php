...
$bg[1]=imagecolorallocate($im,239,239,239);
$bg[2]=imagecolorallocate($im,223,223,223);
$c=imagecolorallocate($im,175,175,175);

// Цвета для столбиков
$bar[2][0]=imagecolorallocate($im,0,0,255);
$bar[2][1]=imagecolorallocate($im,195,195,223);
...
$bar[1][0]=imagecolorallocate($im,0,223,223);
$bar[1][1]=imagecolorallocate($im,0,191,191);
$bar[1][2]=imagecolorallocate($im,0,160,160);

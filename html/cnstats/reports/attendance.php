...
$ADMENU="<table cellspacing=5 cellpadding=0 border=0 width='100%'><tr><td>".$LANG["basesize"].":</td><td align=right>".cNumber($size/1024)."</td></tr><tr><td>".$LANG["baserows"].":</td><td align=right>".cNumber($rows)."</td></tr></table>\n";

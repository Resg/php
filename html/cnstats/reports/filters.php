...
if (empty($title)) {
	...
	if (mysql_num_rows($titles)!=0) {
		print "<table width='".$TW."' cellspacing='1' border='0' cellpadding='3' class=tblborder>\n";
	...
	print "<form action='index.php' class='m0'><table width='100%' cellspacing=1 cellpadding=5 class=tblborder border=0>\n";

...
function ShowCalendar($stamp,$p,$hm) {
	...
	print "<table border=0 bgcolor=#dfdfdf cellspacing=1 cellpadding=2 width=120>";

	print "<tr><td bgcolor=white colspan=7 align=center class=tiny><B>";
	...
	for ($i=1;$i<=$ed;$i++) {
		...
		if (!$tr) {print "<tr bgcolor=#efefef>";$tr=true;}
		$ri=$i<10?"0".$i:$i;
